...
declare const _default: import("react-redux").ConnectedComponent<typeof Playground, Pick<React.ClassAttributes<Playground> & Props & ReduxProps, "ref" | "endpoint" | "subscriptionEndpoint" | "shareEnabled" | "fixedEndpoint" | "configString" | "canSaveConfig" | "onSaveConfig" | "getRef" | "config" | "configPath" | "createApolloLink" | "schema" | "workspaceName" | "headers" | "shareUrl" | "configIsYaml" | "key" | "projectId" | "onSuccess" | "isEndpoint" | "isApp" | "onChangeEndpoint" | "share" | "onChangeSubscriptionsEndpoint" | "graphqlConfig" | "onSaveSettings" | "onChangeSettings" | "onChangeConfig" | "onUpdateSessionCount" | "fixedEndpoints">>;
